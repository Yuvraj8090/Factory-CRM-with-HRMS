<x-app-layout>
    ...
    <section class="app-card">
        ...
        <div class="overflow-x-auto">
            <table id="quotations-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('finance.quotations.index') }}" data-datatable-filter-form="#quotations-filters" data-datatable-storage-key="quotations" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"quotation_number","name"=>"quotation_number"],["data"=>"customer_name","name"=>"customer.name","searchable"=>false],["data"=>"quotation_date_display","name"=>"quotation_date"],["data"=>"status_badge","name"=>"status","orderable"=>false,"searchable"=>false],["data"=>"total_display","name"=>"total"],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($quotations as $quotation)
                        <tr class="transition hover:bg-slate-50/80">
                            ...
                            <td class="px-6 py-5"><div class="flex justify-end gap-2"><a href="{{ route('finance.quotations.show', $quotation) }}" class="btn btn-outline-secondary btn-sm">View</a><a href="{{ route('finance.quotations.edit', $quotation) }}" class="btn btn-outline-secondary btn-sm">Edit</a></div></td>
                        </tr>
                    @empty
