<x-app-layout>
    ...
    <section class="app-card">
        <div class="overflow-x-auto">
            <table id="debit-notes-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('finance.debit-notes.index') }}" data-datatable-storage-key="debit-notes" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"debit_note_number","name"=>"debit_note_number"],["data"=>"customer_name","name"=>"customer.name","searchable"=>false],["data"=>"invoice_number","name"=>"invoice.invoice_number","searchable"=>false],["data"=>"status_badge","name"=>"status","orderable"=>false,"searchable"=>false],["data"=>"total_display","name"=>"total"],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
