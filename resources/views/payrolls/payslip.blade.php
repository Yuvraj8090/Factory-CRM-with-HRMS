<x-app-layout>
    ...
    <section class="mx-auto max-w-4xl app-card app-card-body app-card-body-lg">
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-4">
            <div class="app-surface px-4 py-4"><p class="text-xs uppercase tracking-[0.16em] text-slate-500">Gross</p><p class="mt-2 text-lg font-bold text-slate-950">₹{{ number_format((float) $payrollItem->gross_salary, 2) }}</p></div>
            <div class="app-surface px-4 py-4"><p class="text-xs uppercase tracking-[0.16em] text-slate-500">Deductions</p><p class="mt-2 text-lg font-bold text-slate-950">₹{{ number_format((float) $payrollItem->total_deductions, 2) }}</p></div>
            <div class="app-surface px-4 py-4"><p class="text-xs uppercase tracking-[0.16em] text-slate-500">Taxes</p><p class="mt-2 text-lg font-bold text-slate-950">₹{{ number_format((float) $payrollItem->total_taxes, 2) }}</p></div>
