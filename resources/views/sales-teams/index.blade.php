<x-app-layout>
    ...
    <section class="app-card">
        <div class="overflow-x-auto">
            <table id="sales-teams-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('crm.sales-teams.index') }}" data-datatable-storage-key="sales-teams" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"name","name"=>"name"],["data"=>"team_lead_name","name"=>"teamLead.name","searchable"=>false],["data"=>"members_total","name"=>"members_count"],["data"=>"leads_total","name"=>"leads_count"],["data"=>"status_badge","name"=>"is_active","orderable"=>false,"searchable"=>false],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
