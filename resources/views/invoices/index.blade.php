<x-app-layout>
    ...
    <section class="app-card">
        ...
        <div class="overflow-x-auto">
            <table id="invoices-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('finance.invoices.index') }}" data-datatable-filter-form="#invoices-filters" data-datatable-storage-key="invoices" data-datatable-columns='@json([["data"=>"invoice_number","name"=>"invoice_number"],["data"=>"customer_name","name"=>"customer.name","searchable"=>false],["data"=>"due_date_display","name"=>"due_date"],["data"=>"invoice_status_badge","name"=>"invoice_status","orderable"=>false,"searchable"=>false],["data"=>"payment_status_badge","name"=>"payment_status","orderable"=>false,"searchable"=>false],["data"=>"total_display","name"=>"total"],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]])'>
