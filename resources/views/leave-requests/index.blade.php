<x-app-layout>
    ...
    <section class="app-card">
        ...
        <div class="overflow-x-auto">
            <table id="leave-requests-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('hrms.leave-requests.index') }}" data-datatable-filter-form="#leave-requests-filters" data-datatable-storage-key="leave-requests" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"employee_name","name"=>"user.name","searchable"=>false],["data"=>"leave_type_name","name"=>"leaveType.name","searchable"=>false],["data"=>"dates_display","name"=>"start_date"],["data"=>"days_total","name"=>"total_days"],["data"=>"status_badge","name"=>"status","orderable"=>false,"searchable"=>false],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
