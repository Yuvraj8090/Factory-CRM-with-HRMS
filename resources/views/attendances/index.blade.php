<x-app-layout>
    ...
    <section class="app-card">
        ...
        <div class="overflow-x-auto">
            <table id="attendances-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('hrms.attendances.index') }}" data-datatable-filter-form="#attendances-filters" data-datatable-storage-key="attendances" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"employee_name","name"=>"employeeUser.name","searchable"=>false],["data"=>"date_display","name"=>"date"],["data"=>"shift_display","name"=>"check_in","searchable"=>false],["data"=>"hours_display","name"=>"work_hours"],["data"=>"status_badge","name"=>"status","orderable"=>false,"searchable"=>false],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
