...
<div class="space-y-6">
    <section class="app-card app-card-body">
        ...
        <div class="mt-6 grid gap-6 lg:grid-cols-2">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-2 space-y-3 app-panel p-4">
    ...
    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <a href="{{ route('settings.whats-app-templates.index') }}" class="btn btn-outline-secondary">Cancel</a>
        <button type="submit" class="btn btn-primary">{{ $whatsAppTemplate ? 'Update Template' : 'Save Template' }}</button>
    </div>
</div>
