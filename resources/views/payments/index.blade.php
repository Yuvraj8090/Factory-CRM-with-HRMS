<x-app-layout>
    ...
    <section class="app-card">
        ...
        <div class="overflow-x-auto">
            <table id="payments-table" class="table table-hover app-data-table text-sm" data-datatable-url="{{ route('finance.payments.index') }}" data-datatable-filter-form="#payments-filters" data-datatable-storage-key="payments" data-datatable-columns='{{ \Illuminate\Support\Js::from([["data"=>"payment_number","name"=>"payment_number"],["data"=>"customer_name","name"=>"customer.name","searchable"=>false],["data"=>"invoice_number","name"=>"invoice.invoice_number","searchable"=>false],["data"=>"payment_method_display","name"=>"payment_method"],["data"=>"amount_display","name"=>"amount"],["data"=>"actions","name"=>"id","orderable"=>false,"searchable"=>false]]) }}'>
